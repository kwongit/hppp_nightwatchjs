...
module.exports = {
  ...
  '[04] - Select listing type: | Room for rent' : function (client) {
      ...
      listingTypes.click('@selectRoomForRent');
      client.pause(1000);
  },

  '[05] - Select property type: | Condo Apartment' : function (client) {
      ...
      propertTypes.click('@condoApartment');
      client.pause(1000);
  },
  ...
  '[06] - Verify property type: Condo Apartment' : function (client) {
      ...
      verifyPropertyTitle.waitForElementVisible('@roomForRentCondoApartmentTitle', 100, false);
      client.pause(1000);
  },
