...
module.exports = {
  ...
  '[05] - Select property type: | Townhouse' : function (client) {
  ...
  '[06] - Verify property type: Townhouse' : function (client) {
      ...
      verifyPropertyTitle.waitForElementVisible('@roomForRentTownhouseTitle', 100, false);
      client.pause(1000);
  },
